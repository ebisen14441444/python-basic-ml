...
この教材は、機械学習講習会に進む前の準備として、Pythonの基本文法、データ処理、簡単な可視化、機械学習でよく使う考え方を短時間で確認するためのものです。
...
左のメニューから順番に読み進めてください。最初に環境を確認し、その後でPythonの基本文法、データ構造、NumPyとPandas、機械学習講習会への接続を扱います。
